...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'rounded-[1.5rem] border border-border/90 bg-card/82 text-card-foreground shadow-[0_20px_60px_-36px_hsl(var(--foreground)_/_0.18)] backdrop-blur-sm transition-all duration-300',
      className,
    )}
    {...props}
  />
