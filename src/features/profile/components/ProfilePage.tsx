...
export function ProfilePage({ locale }: ProfilePageProps) {
  ...
  return (
    <main className="relative isolate overflow-hidden pt-5">
      <div className="pointer-events-none absolute inset-x-0 top-0 -z-10 hidden h-[30rem] bg-[radial-gradient(circle_at_top,hsl(var(--accent)_/_0.1),transparent_48%)] dark:block" />
